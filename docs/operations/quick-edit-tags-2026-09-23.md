...
런타임 변경은 Android에 한정하며 기존 서버의 optional tags 계약을 사용합니다. Functions·Web 실행 코드가 바뀌지 않아 Firebase·Web 재배포는 필요하지 않습니다. Android v1.2.30(versionCode 32)은 [GitHub Release](https://github.com/minkue777/household-account/releases/tag/v1.2.30)로 공개됐습니다. 태그는 `6a75b298bdd707f2e3d3c1321f8c0c43556b38de`를 가리키며 다운로드 HTTP 200, 11,421,551바이트 및 위 SHA-256 일치를 확인했습니다. 후속 테스트·문서 변경은 APK 재발행 대상이 아닙니다.
