...
| T-AST-004 | 목표 | 전날에만 owner A·type stock이 있고 오늘 자산이 0개인 가구 / snapshot projection / total·financial·owner A·stock 모두 명시적 0원이고 NoData가 아님 | AST-008 |
