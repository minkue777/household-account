...
| T-JOB-AST-001 | 목표 | 국내·미국 주식·ETF·펀드·코인·실물 금과 전날 마지막 owner·type 자산, 100개 초과 종목, 일부 timeout / 다른 화면에서 자산 페이지 진입 1회·23:55 전체 평가와 snapshot intent / 페이지 체류·visibility 복귀로 반복하지 않고, 한 run의 모든 계좌를 원자 반영하며 모든 내부 page를 처리하고 성공 Quote와 실패 대상 마지막 Quote로 평가한다. 사라진 scope는 0원이며 중복 run은 없다. | JOB-AST-001, JOB-AST-002, AST-008, DEC-049 |
