...
| T-SPL-004 | 목표 | 원본과 월 분할 그룹, 한 항목 version 경합, captured 월 그룹 취소, 취소 명령 처리 중인 Web 편집 모달 / collapse·lineage cancel·UI 전환 / collapse는 파생 제거·같은 원본 ID 재활성화, 취소는 원본·그룹 전체 삭제와 claim cancelled, 경합 시 그룹 전체 유지, Web 모달은 권위 snapshot이 선택 파생 항목을 제거하기 전까지 닫히지 않음 | SPL-003, LED-008, LED-009, DEC-041 |
