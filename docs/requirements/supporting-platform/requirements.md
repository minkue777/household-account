...
| 분류 | 기능 모듈 | 요구사항 | 개수 | 책임 |
|---|---|---|---:|---|
| Delivery / Android | [Android Host](modules/android-host/requirements.md) | AND-*, QE-* | 26 | 권한, WebView, Bridge, QuickEdit UI |
...
| Operations | [외부 운영](modules/external-operations/requirements.md) | JOB-ERR-*, EXT-* | 6 | 외부 오류 분류, job 결과, retry·관측 |
