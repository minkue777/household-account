...
| [DEC-062](governance/decisions.md#dec-062) | Portfolio·지원 플랫폼 | 배당 공시 discovery와 lifecycle sweep을 한국 시간 평일(월~금) 19:00에 1회 실행하고 토·일에는 실행하지 않으며, 19:00 이후 공시는 다음 평일 19:00에, 금요일 19:00 이후와 주말 공시는 월요일 19:00에 반영한다. |
