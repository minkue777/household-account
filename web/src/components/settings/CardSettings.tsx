...
function getCardStyle(cardLabel: string) {
  switch (cardLabel) {
    case '국민':
      return {
        container:
          'border border-transparent bg-[#f7cf52] shadow-[0_18px_34px_-18px_rgba(161,98,7,0.52)] hover:border-transparent',
    ...
    case '삼성':
      return {
        container:
          'border border-transparent bg-[#79addb] shadow-[0_14px_28px_-16px_rgba(8,47,73,0.34)] hover:border-transparent',
        title: 'text-slate-900',
        number: 'text-sky-900',
    ...
    case '농협':
      return {
        container:
          'border border-transparent bg-[#223864] shadow-[0_10px_24px_-16px_rgba(15,23,42,0.48)] hover:border-transparent',
        title: 'text-white',
    ...
    case '롯데':
      return {
        container:
          'border border-transparent bg-[#e2e2e6] shadow-[0_14px_28px_-16px_rgba(100,116,139,0.34)] hover:border-transparent',
        title: 'text-slate-900',
    ...
    case '비씨':
      return {
        container:
          'border border-transparent bg-[#efadb5] shadow-[0_16px_30px_-18px_rgba(190,24,93,0.28)] hover:border-transparent',
        title: 'text-slate-900',
    ...
    case '현대':
      return {
        container:
          'border border-transparent bg-[#2f2f2f] shadow-[0_12px_26px_-16px_rgba(0,0,0,0.46)] hover:border-transparent',
        title: 'text-white',
        number: 'text-white/95',
        mark: 'text-white/65',
      };
    case '네이버페이':
      return {
        container:
          'border border-transparent bg-[#0ecf44] shadow-[0_10px_24px_-16px_rgba(22,163,74,0.38)] hover:border-transparent',
        title: 'text-white',
    ...
    case '카카오페이':
      return {
        container:
          'border border-transparent bg-[#ffe138] shadow-[0_10px_24px_-16px_rgba(161,98,7,0.3)] hover:border-transparent',
        title: 'text-slate-900',
    ...
    case '토스':
      return {
        container:
          'border border-transparent bg-[#2763f5] shadow-[0_10px_24px_-16px_rgba(29,78,216,0.46)] hover:border-transparent',
        title: 'text-white',
        number: 'text-white/95',
        mark: 'text-white/70',
      };
    case '대전사랑카드':
      return {
        container:
          'border border-transparent bg-[#f8f2f2] shadow-[0_14px_28px_-16px_rgba(127,29,29,0.26)] hover:border-transparent',
        title: 'text-slate-900',
        number: 'text-slate-800',
    ...
    default:
      return {
        container:
          'border border-slate-200 bg-[#fbfcfd] shadow-[0_10px_24px_-18px_rgba(15,23,42,0.35)] hover:border-violet-200',
        title: 'text-slate-900',
