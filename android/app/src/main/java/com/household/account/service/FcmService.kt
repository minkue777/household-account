 ...
 * - FCM 등록 완료/해제 callback을 인증된 서버 Command로 전달
...
class FcmService : FirebaseMessagingService() {
    ...
    override fun onRegistered(installationId: String) {
        FidEndpointManager.onRegistered(applicationContext, installationId)
    }

    override fun onUnregistered(installationId: String) {
        FidEndpointManager.onUnregistered(applicationContext, installationId)
    }
